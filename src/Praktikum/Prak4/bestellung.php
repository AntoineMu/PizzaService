...
class Bestellung extends Page
{
    ...
    protected function generateView():void
    {
        ...
        foreach ($data as &$value) {
            ...
            echo <<<EOT
                <article>
                    <img src="../images/$value[picture]" id=$value[name] alt="gif of a pizza" title="pizza image"  width="250" height="250" data-preis=$value[price] onclick="addToWarenkorb('$value[name]', '$value[article_id]', this)"/>
                    <br>$value[name]
                    <br>$value[price]
                </article>
EOT;
        ...
        <section>
            ...
            <form action="bestellung.php" method="post" accept-charset="UTF-8" onSubmit="return formularOK()">
                ...
                <select Name="Warenkorb[]" id="warenkorb" tabindex="1" Size="10" multiple>  
                ...
                <input type="reset" name="löschen" value="Alle Löschen" onclick="alleLöschen()">
                <input type="button" name="ausgewählt löschen" value="Auswahl Löschen" onclick="auswahlLöschen()">
                <input type="submit" name="bestellen" id="bestellen" value="Bestellen" onclick="">
            </form> 
        </section>
EOT;
