...
class Baecker extends Page
{
    ...
    protected function generateView():void
    {
        ...
        $this->generatePageHeader('Bäcker', 'pizzaScript.js'); 
        ...
        foreach($data as $value){
            ...
            echo <<<EOT
                <form action="baecker.php" method="post" id="$oaid">
                    <h3>Bestellung $value[ordering_id] - Pizza $value[name]</h3>
                    <label><input type="radio" name="status" id="bestellt$oaid" value="0" onclick="submitOnClick($oaid)" $bestellt>bestellt</label>
                    <label><input type="radio" name="status" id="imOfen$oaid" value="1" onclick="submitOnClick($oaid)" $imOfen>im Ofen</label>
                    <label><input type="radio" name="status" id="fertig$oaid" value="2" onclick="submitOnClick($oaid)" $fertig>fertig</label>
